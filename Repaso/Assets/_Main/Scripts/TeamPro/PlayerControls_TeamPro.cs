...
public class PlayerControls_TeamPro : IInputActionCollection, IDisposable
{
    ...
    public PlayerControls_TeamPro()
    {
        asset = InputActionAsset.FromJson(@"
        {
            ""name"": ""PlayerControls_TeamPro"",
            ""maps"": [
                {
                    ""name"": ""Player"",
                    ""actions"": [
    ...
    // Input System actual: devices es nullable en la interfaz
    public ReadOnlyArray<InputDevice>? devices
    {
        get => asset.devices;
        set
        {
            if (value.HasValue) asset.devices = value.Value;
            else asset.devices = default;
        }
    }
    ...
    {
        private readonly PlayerControls_TeamPro m_Wrapper;
        public PlayerActions(PlayerControls_TeamPro wrapper) { m_Wrapper = wrapper; }
